action :create do
  params = Hash.new()
  attributes = ['notify_master', 'notify_backup', 'notify_fault', 'interface', 'virtual_router_id', 'state', 'nopreempt', 'priority', 'virtual_ipaddress', 'virtual_ipaddress_cidr', 'virtual_routes', 'advert_int', 'auth_type', 'auth_pass', 'track_script']
